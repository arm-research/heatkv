...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate 8B Infinity images with and without HeatKV.")
    parser.add_argument("--prompt", default="A photo of a red sports car on a mountain road")
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--gpu", type=int, default=0)
    parser.add_argument("--output-dir", default="outputs/heatkv_8b_comparison")
    ...
    baseline_path = output_dir / "8b_without_heatkv.png"
    heatkv_path = output_dir / "8b_with_heatkv.png"
    comparison_path = output_dir / "8b_comparison.png"
    ...
    model = enable_real_pruning_scale_specific_fused_segmented(
        model,
        args.heatkv_budget,
        orders(args.heatkv_initial_scales, model_type=8),
